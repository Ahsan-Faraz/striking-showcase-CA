...
const defaultAthlete = {
  ...
  videos: [
    { title: 'Holiday Classic Finals', date: 'Dec 2025', views: '1.2K' },
    { title: 'Practice Session — Dec 2025', date: 'Dec 2025', views: '845' },
    { title: 'Illinois State Championship', date: 'Sep 2025', views: '2.1K' },
    { title: 'Arlington Classic Highlights', date: 'Nov 2025', views: '678' },
  ],
  articles: [
...
type LayoutType = 'classic' | 'spotlight' | 'editorial';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
          {([
            ...
            { key: 'spotlight' as LayoutType, label: 'SPOTLIGHT' },
            { key: 'editorial' as LayoutType, label: 'EDITORIAL' },
          ]).map((l) => (
            <button
              key={l.key}
        ...
        <div>
          ...
          <div
            ...
            style={{
              ...
              zIndex: 2,
              overflow: 'hidden',
              background: theme === 'light' ? C.heroBg : `linear-gradient(160deg, ${s.deep} 0%, ${sRgba(0.85)} 30%, #1A1524 70%, #0a0a0f 100%)`,
            }}
          >
            {/* Radial gold glow */}
            <div style={{
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px 80px', position: 'relative', zIndex: 2 }}>
            ...
            <Reveal delay={100}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 40 }}>
                {[
                  { label: 'GPA', value: '3.8', isNum: true },
                  { label: 'ACT', value: '28', isNum: true },
                  { label: 'SAT', value: '1320', isNum: true },
                  { label: 'NCAA', value: 'Eligible', isNum: false },
                ].map((card) => (
              ...
              <Reveal delay={150}>
                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 16 }}>
                  <div className="video-card" style={{
                    ...
                    <div style={{
                      display: 'flex', gap: 16, fontFamily: 'var(--font-dm-mono), monospace',
                      fontSize: 11, color: C.textDim, position: 'relative', zIndex: 1,
                    }}>
                      <span>{athlete.videos[0].date}</span>
                      <span>{athlete.videos[0].views} views</span>
                    </div>
                  </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridTemplateRows: 'repeat(2, 180px)', gap: 12 }}>
                  <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
                      ...
                      <span style={{ fontFamily: 'var(--font-dm-mono), monospace', fontSize: 11, color: C.textDim }}>FEATURED PHOTO</span>
                    </div>
                  </div>
                  {[1, 2].map((i) => (
                    <div key={i} style={{
      ...
      {layout === 'spotlight' && (
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', minHeight: 520, position: 'relative', zIndex: 2 }}>
            {/* Photo area */}
            <div style={{
              position: 'relative', overflow: 'hidden',
              background: theme === 'light' ? C.heroBg : `linear-gradient(160deg, ${s.deep} 0%, ${sRgba(0.85)} 30%, #1A1524 100%)`,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
              {/* Noise texture */}
              ...
              {[
                ...
                <div key={s.label} style={{
                  ...
                  <AnimatedNumber
                    ...
                    style={{
                      fontFamily: 'var(--font-exo2), sans-serif', fontWeight: 800,
                      fontSize: s.highlight ? 48 : 32, lineHeight: 1,
                    }}
                  />
                </div>
              ))}
