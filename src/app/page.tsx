...
import { Counter, FaqItem, StickyBars } from '@/components/landing/ClientComponents';

export const metadata: Metadata = {
  title: 'Striking Showcase — The First Recruiting Platform for Youth Bowlers',
  description:
    'Build your professional bowling recruiting profile. Get discovered by college coaches. Your stats, your videos, your story — one link that changes everything.',
  openGraph: {
    title: 'Striking Showcase — The First Recruiting Platform for Youth Bowlers',
    description:
      'Build your professional bowling recruiting profile. Get discovered by college coaches.',
  ...
  twitter: {
    ...
    description: 'The First Recruiting Platform for Youth Bowlers',
  },
  alternates: {
    canonical: 'https://strikingshowcase.com',
  },
};
