...
export default function TournamentsPage() {
  ...
  const avgPlacement =
    tournaments.length > 0
      ? (
          tournaments.reduce((sum, t) => sum + t.place, 0) / tournaments.length
        ).toFixed(1)
      : "--";
  const avgScore =
    tournaments.length > 0
      ? (
          tournaments.reduce((sum, t) => sum + t.average, 0) /
          tournaments.length
        ).toFixed(1)
      : "--";
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4 animate-in-delay-1">
        <Card
          className="text-center py-5 border-t-2 border-t-gold/40"
          hoverable
        >
          <p className="font-heading text-3xl font-bold text-gold">
            {tournaments.length}
          </p>
          <p className="text-xs text-[var(--text-tertiary)] uppercase tracking-wider font-mono mt-1">
            Tournaments
          </p>
        </Card>
        <Card
          className="text-center py-5 border-t-2 border-t-maroon/40"
          hoverable
        >
          <p className="font-heading text-3xl font-bold text-gold">
            {avgPlacement}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Kansas State Championship"
                    required
                  />
                </div>
                <div>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <p className="text-sm text-[var(--text-tertiary)] mt-2 max-w-sm mx-auto">
                Add your tournament results to build your competitive resume for
                college coaches
              </p>
            </div>
          ) : (
              ...
              {tournaments.map((t) => (
                <div
                  ...
                  className={cn(
                    ...
                    t.place <= 3
                      ? "bg-gold/[0.04] border border-gold/10 hover:border-gold/20"
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={cn(
                        ...
                        t.place === 1 &&
                          "bg-gold/20 text-gold shadow-glow-gold/20",
                        t.place === 2 &&
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      ...
                      <p className="text-[10px] text-[var(--text-tertiary)] uppercase font-mono">
                        Average
                      </p>
                    </div>
                    <button
